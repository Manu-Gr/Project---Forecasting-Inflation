...
with dataset:
    st.header('Inflation Dataset')
    
    india = get_data('C:/Users/91890/Data Science - John Sir Class - 12 Oct/Stock Prediction (geek for geeks)/New India data _1980(csv).csv')
...
india_month_interpolated = pd.read_csv(r'C:/Users/91890/Downloads/india_month.csv')
...
india_month_interpolated1 = pd.read_csv(r'C:/Users/91890/Downloads/india_month_interpolated1.csv')
